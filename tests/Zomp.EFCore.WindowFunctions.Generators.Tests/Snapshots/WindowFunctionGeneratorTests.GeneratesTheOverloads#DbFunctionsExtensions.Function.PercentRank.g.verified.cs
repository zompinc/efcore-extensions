...
{
    /// <summary>
    /// The PERCENT_RANK() window function returns the percent rank value of the expression across all input values.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions"/> instance.</param>

    /// <param name="over">over clause.</param>
    /// <returns>PercentRank for the selected window frame.</returns>
    ...
    public static double PercentRank(this DbFunctions _, OverClause over)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(PercentRank))  + UseWindowFunctions);
}
...
{
    /// <inheritdoc/>
    [SuppressMessage("Naming", "CA1725:Parameter names should match base declaration", Justification = "EF Core 11 renamed the base parameter; one name serves every EF Core version")]
